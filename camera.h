...
//if CAMERA_SERIAL_PORT_1 == 1, using port 1, etc.
/*
#define CAMERA_SERIAL_PORT_1 1
#define CAMERA_SERIAL_PORT_2 2 
static int current_camera_serial_port = CAMERA_SERIAL_PORT_2;
*/
...
#endif
/*
//when current_camera_serial_port == CAMERA_SERIAL_PORT_1,
//  current_terminal_serial_port = TERMINAL_SERIAL_PORT_2
#define TERMINAL_SERIAL_PORT_1 1
#define TERMINAL_SERIAL_PORT_2 2
static int current_terminal_serial_port = TERMINAL_SERIAL_PORT_1;
*/
...
#define R_MIN_DEFAULT	70	// Rmin for call to Track_Color()
#define R_MAX_DEFAULT	120	// Rmax for call to Track_Color()
#define G_MIN_DEFAULT	200	// Gmin for call to Track_Color()
#define G_MAX_DEFAULT	255	// Gmax for call to Track_Color()
#define B_MIN_DEFAULT	140 // Bmin for call to Track_Color()
#define B_MAX_DEFAULT	255 // Bmax for call to Track_Color()
#define NF_DEFAULT		6	// value for call to Noise_Filter()
#define AGC_DEFAULT		255	// Automatic Gain Control Register [0/0x00]
...
#define BRT_DEFAULT		255	// Brightness Control Register [128/0x80]
#define AEC_DEFAULT		1	// Automatic Exposure Control Register [127/0x7F]
#define COMA_DEFAULT	40	// Common Control A Register [36/0x24]
...
// function prototypes
unsigned char Camera_Handler(void);
...
char can_see_light_p(void);
char light_centered_p(void);

/*
#define CAMERA_ONE 1
#define CAMERA_TWO 2 
static int current_camera = CAMERA_ONE;
static int camera_two_initialized = 0;
int get_current_camera_num(void);
void set_current_camera(int num);
*/
